classdef bayesian_optimization_controller < handle
    ...
    methods
        ...
        function optimize(obj)
            ...
            elseif this_time  > ...
                ...
                if obj.n_samples >= obj.n_burn_in 
                    % Update GP model
                    obj.gp_model.initialize_data(obj.parameter_vector, obj.sample_results, obj.lower_bound, obj.upper_bound) 
                   
                    if obj.n_parameters == 2
                        subplot(1,3,1)
                        obj.gp_model.plot_mean();

                        subplot(1,3,2)
                        obj.gp_model.plot_upper_confidence_bound();
                        view(0,90)
        ...
        function select_next_sample(obj)
            ...
            if obj.n_samples <= obj.n_burn_in
                ...
                obj.parameter_vector(obj.n_samples,:) = obj.gp_model.discrete_aquisition_function(2,.2);
