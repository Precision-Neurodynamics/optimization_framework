classdef opto_bayesian_optimization_controller_3 < handle
    ...
    methods
        ...
        function initialize(obj, gp_model)
            ...
            if isempty(obj.O_Window)
                obj.O_Window       = obj.objective_window_s/2;
            end
...
%                 if obj.n_samples >= obj.samples_per_cycle
        ...
        function evaluate_second_objective_function(obj)
            ...
            obj.iter_results(obj.n_iter,1) =  -p(2)/p(1);%-(p(2)^2/p(1)); %p(1) = slope, p(2) = y intercept
