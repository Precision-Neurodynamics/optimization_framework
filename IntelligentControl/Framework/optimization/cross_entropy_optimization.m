classdef cross_entropy_optimization < handle
    ...
    methods
        ...
        function calibrate(obj)
            ...
            windows     = 1:obj.objective_window_s:this_time;
            baseline    = nan(1,size(windows,2)-1);
            
            if this_time > obj.calibration_time_s+1
                for c1 = 1:size(windows,2)-1
                    baseline(c1) = obj.objective_function.get_metric(windows(c1), windows(c1+1));
                end
                obj.calibration_done = 1;
            end
...
%                 end
            ...
            elseif this_time  > ...
                    obj.evaluate_delay_s + obj.stimulator.stimulation_duration + obj.stimulator.stimulation_time + obj.objective_window_s && ...
                    ~obj.stimulator.stimulation_armed
        ...
        function evaluate_objective_function(obj)
            objective_window_start  = obj.stimulator.stimulation_time + obj.stimulator.stimulation_duration + obj.evaluate_delay_s;
