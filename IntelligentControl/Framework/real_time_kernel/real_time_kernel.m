function stimulation_log = real_time_kernel(TD)
close all;  
clc;  
dbstop if error;
...
% EXPERIMENT_TYPE = 'SDBO_controller';
...
switch EXPERIMENT_TYPE 
    case 'grid_search'
        [optimization_object, stim_manager, metric_objects] = ...
            configure_grid_search(TD, DEBUG, ANIMAL_ID);      
    case 'cross_entropy'
...
%         display_objects = metric_objects;
    case 'bayesian_optimization_controller'
        [optimization_object, ~, metric_objects] = ...
            configure_bayesian_optimization_controller(TD, DEBUG, ANIMAL_ID);
    case 'SDBO_controller'
        [optimization_object, ~, metric_objects] = ...
            configure_SDBO_controller(TD, DEBUG, ANIMAL_ID);
end
...
stimulation_log = stim_manager.stimulation_log;
TD.SetSysMode(0)
end
